      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-16">
          ...
          <div className="lg:col-span-4 flex flex-col items-start">
            ...
            {/* Doctor Profile Mini */}
            <div className="flex items-center gap-3 mb-5 p-3 rounded-2xl bg-white border border-gray-100 shadow-sm w-full max-w-[280px]">
              <Image 
                src="/images/doctor-portrait.png" 
                alt="Dr. Alexander Mercer" 
                width={48} 
                height={48} 
                className="rounded-full object-cover w-12 h-12 bg-primary-50" 
              />
              <div>
                <h4 className="font-serif font-bold text-sm text-dark">Dr. Alexander Mercer</h4>
                <p className="text-[10px] uppercase tracking-widest text-primary font-bold mt-0.5">Head Dentist</p>
              </div>
            </div>
            ...
            <ul className="space-y-3.5 w-full">
              ...
              <li className="flex items-center gap-3 text-sm text-rose-500 font-bold mt-2 bg-rose-50 px-3 py-2.5 rounded-xl border border-rose-100 w-fit">
                <Phone className="w-4 h-4 shrink-0" />
                <a href="tel:+918866902356" className="hover:text-rose-600 transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded px-1">
                  Emergency: +91 88669 02356
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <a
              href="#"
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 text-[11px] uppercase tracking-wider font-bold text-dark group"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="group-hover:scale-110 transition-transform">
